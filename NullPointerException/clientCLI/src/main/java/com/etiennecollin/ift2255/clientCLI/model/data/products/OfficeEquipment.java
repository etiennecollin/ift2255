 ...
 *
 * This class includes specific attributes such as brand and model for office equipment.
 */
public class OfficeEquipment extends Product {
    ...
    /**
     * The model of the office equipment.
     */
     ...
     *
     * @param model The new model to set for the office equipment.
     */

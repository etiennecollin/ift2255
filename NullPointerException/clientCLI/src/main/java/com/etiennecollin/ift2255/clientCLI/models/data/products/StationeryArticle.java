 ...
 * specific to stationery articles such as brand and models.
 */
public class StationeryArticle extends Product {
    ...
    /**
     * The models of the stationery article.
     */
    ...
    /**
     * Gets the models of the stationery article.
     *
     * @return The models of the stationery article.
     */
    ...
    /**
     * Sets the models of the stationery article.
     *
     * @param model The models to set.
     */
